...
@ActiveProfiles("int-test-db")
public class TicketGeneratorServerIntTestDbTest {

	private static final Log LOGGER = LogFactory.getLog(TicketGeneratorServerIntTestDbTest.class);
